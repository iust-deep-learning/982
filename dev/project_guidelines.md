...
We strongly suggest you do the project in a team.  A team can have a maximum of **two members** and remember we will review each member's contribution individually. For the project topic, you can either define the project based on our default topics or implement a new/customized task/dataset (by crawling an Iranian website or defining a new interesting task). You can also pick any of the tasks from SemEval-2020. You must build a system from scratch, to cope with all the difficulties of data preparation, preprocessing and parameter settings.
...
No matter how you came with the project idea (whether it's one of the pre-defined topics or not), we need you to complete the proposal. It shows how well you have understood the problem and how well you have explored the problem space. We'll review the proposal and inform you whether we think the scope of the project is too narrow or too wide.
...
**# Deliverables:**
* You need to submit the propsoal in pdf format here: [https://forms.gle/zCxFRMZSBZXsf8sS7](https://forms.gle/zCxFRMZSBZXsf8sS7)
